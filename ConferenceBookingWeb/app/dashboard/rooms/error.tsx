'use client';
// app/dashboard/rooms/error.tsx — Rooms Error Boundary
// Requirement 3: Resilient UI Patterns (Next.js App Router file conventions)
//
// Catches unhandled render-time errors in /dashboard/rooms.
// `reset()` re-renders the segment — component re-mounts and retries.
...
export default function RoomsError({
  ...
  useEffect(() => {
    console.error('[Rooms Error Boundary]', error);
  }, [error]);
